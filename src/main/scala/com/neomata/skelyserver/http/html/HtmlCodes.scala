...
object HtmlCodes {
  ...
  def mainPage: String = {
    s"""<!DOCTYPE html>
       ...
       |                <p><input type="radio" name="question7" value="Hyper">Train every moment until I feel my life slipping away, I will achieve greatness</p>
       |                <p><input type="radio" name="question7" value="Balance">Constantly push myself hard to reach my limit. I should...no I must find my potential</p>
       |                <p><input type="radio" name="question7" value="Intel">I will seek a master to teach me. I need to be as efficient in each training as possible</p>
       |                <p><input type="radio" name="question7" value="Optimistic">I will find true absolution. I know that if I train properly I will reach the ultimate destiny</p>
       |            </div>
       |            <div>
       ...
       |                <p><input type="radio" name="question8" value="Intimidation">You dare accuse me? I will break every bone in your body and drill holes in your skull.</p>
       |                <p><input type="radio" name="question8" value="Logos">How could I have been the one to kill him, I have black hair and I'm lightskinned. Doesn't fit the profile. </p>
       |                <p><input type="radio" name="question8" value="Pathos">Please... no. I swear I wasn't the one please! I'll do anything!</p>
       |                <p><input type="radio" name="question8" value="Ethos">Me and you..we're the same. Two people with a lot of money and even more responsibility. I don't know who you think I am, but if you come after me I'll have no choice but to reciprocate</p>
       |            </div>
       |            <div>
       |                <h4>9. Hold your breath, how long?: </h4>
       |                <p><input type="time" name="question9 id="q9"</p>
       |            </div>
       ...
       |            <button onclick="toggleQuestion10()">Ready</button>
       |            <div id="toggle">
       ...
       |                <p><input type="radio" name="question10" value="Safety">Reach for your knife and cut the shoe string, but risk dropping the perfect gear in the cavern below.</p>
       |                <p><input type="radio" name="question10" value="One Shoe">Slide your foot out of your boot and rush to the exit</p>
       |                <p><input type="radio" name="question10" value="Lucky">Throw the perfect gear out of your possession and get your boot free, make a break for the exit. </p>
       |                <p><input type="radio" name="question10" value="Half">Drop some of the pieces from the perfect gear making it an almost-perfect gear so you will have enough energy to hold it and yank your foot.</p>
       |            </div>
       |        </form>
       |        <script>
       |            function toggleQuestion10() {
       |                var q10 = document.getElementById("blade");
       |                if (q10.style.display == "none") {
